package com.probe.rpc.thrift.server.argument;
...
import com.probe.rpc.thrift.server.exception.ThriftServerException;
import com.probe.rpc.thrift.server.processor.TRegisterProcessor;
import com.probe.rpc.thrift.server.processor.TRegisterProcessorFactory;
import com.probe.rpc.thrift.server.properties.TThreadedSelectorServerProperties;
...
public class TThreadedSelectorServerArgument extends TThreadedSelectorServer.Args {
	...
	public TThreadedSelectorServerArgument(List<ThriftServiceWrapper> serviceWrappers,
			ThriftServerProperties properties) throws TTransportException {
	...
	private ExecutorService createInvokerPool(ThriftServerProperties properties) {
		...
		return new ThreadPoolExecutor(threadedSelectorProperties.getMinWorkerThreads(),
				threadedSelectorProperties.getMaxWorkerThreads(), threadedSelectorProperties.getKeepAlivedTime(),
				TimeUnit.MINUTES, new LinkedBlockingQueue<>(properties.getWorkerQueueCapacity()));
	}
