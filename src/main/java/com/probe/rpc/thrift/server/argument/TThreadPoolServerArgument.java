...
import com.probe.rpc.thrift.server.properties.TThreadPoolServerProperties;
...
public class TThreadPoolServerArgument extends TThreadPoolServer.Args {
	...
	private ExecutorService createInvokerPool(ThriftServerProperties properties) {
		...
		return new ThreadPoolExecutor(threadPoolProperties.getMinWorkerThreads(),
				threadPoolProperties.getMaxWorkerThreads(), threadPoolProperties.getKeepAlivedTime(), TimeUnit.MINUTES,
